...
namespace Akamon\OAuth2\Server\Domain\Tests\Service\Client\ClientObtainer;
...
class AuthenticatedClientObtainerTest extends OAuth2TestCase
{
    ...
    {
        $this->credentialsObtainer = $this->mock('Akamon\OAuth2\Server\Domain\Service\Client\ClientCredentialsObtainer\ClientCredentialsObtainerInterface');
    ...
    /**
     * @expectedException \Akamon\OAuth2\Server\Domain\Exception\OAuthError\InvalidClientCredentialsOAuthErrorException
     */
