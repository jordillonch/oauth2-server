...
class RefreshTokenCreatorTest extends OAuth2TestCase
{
    ...
    {
        $this->tokenGenerator = $this->mock('Akamon\OAuth2\Server\Domain\Service\Token\TokenGenerator\TokenGeneratorInterface');
    ...
    public function testCreate()
    {
        ...
        $this->assertInstanceOf('Akamon\OAuth2\Server\Domain\Model\RefreshToken\RefreshToken', $refreshToken);
        $this->assertSame([
            'token' => $token,
            'accessTokenToken' => 'foo',
            'createdAt' => time(),
