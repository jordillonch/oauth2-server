...
namespace Akamon\OAuth2\Server\Domain\Tests\Service\Token\RequestAccessTokenObtainer;
...
class RequestAccessTokenObtainerTest extends OAuth2TestCase
{
    ...
    {
        $this->accessTokenDataObtainer = $this->mock('Akamon\OAuth2\Server\Domain\Service\Token\AccessTokenDataObtainer\AccessTokenDataObtainerInterface');
        $this->accessTokenObtainer = $this->mock('Akamon\OAuth2\Server\Domain\Service\Token\AccessTokenObtainer\AccessTokenObtainerInterface');
    ...
    /**
     * @expectedException \Akamon\OAuth2\Server\Domain\Exception\OAuthError\ExpiredAccessTokenOAuthErrorException
     */
