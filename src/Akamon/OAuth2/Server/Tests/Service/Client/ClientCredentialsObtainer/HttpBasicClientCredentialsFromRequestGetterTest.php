...
namespace Akamon\OAuth2\Server\Tests\Service\Client\ClientCredentialsObtainer;
...
{
    /** @var \Akamon\OAuth2\Server\Service\Client\ClientCredentialsObtainer\HttpBasicClientCredentialsObtainer */
    private $obtainer;

    protected function setUp()
    {
        $this->obtainer = new \Akamon\OAuth2\Server\Service\Client\ClientCredentialsObtainer\HttpBasicClientCredentialsObtainer();
    }
