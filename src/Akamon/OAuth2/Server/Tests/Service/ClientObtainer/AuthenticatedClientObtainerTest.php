...
namespace Akamon\OAuth2\Server\Tests\Service\ClientObtainer;
...
class AuthenticatedClientObtainerTest extends OAuth2TestCase
{
    ...
    {
        $this->credentialsObtainer = $this->mock('Akamon\OAuth2\Server\Service\ClientCredentialsObtainer\ClientCredentialsObtainerInterface');
