...
class RefreshTokenGrantTypeProcessorTest extends OAuth2TestCase
{
    ...
    {
        $this->refreshTokenRepository = $this->mock('Akamon\OAuth2\Server\Model\RefreshToken\RefreshTokenRepositoryInterface');
        $this->accessTokenRepository = $this->mock('Akamon\OAuth2\Server\Model\AccessToken\AccessTokenRepositoryInterface');
    ...
    /**
     * @expectedException \Akamon\OAuth2\Server\Exception\OAuthError\RefreshTokenNotFoundOAuthErrorException
     */
