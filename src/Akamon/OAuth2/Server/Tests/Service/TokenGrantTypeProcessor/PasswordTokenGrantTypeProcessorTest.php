...
namespace Akamon\OAuth2\Server\Tests\Service\TokenGrantTypeProcessor;
...
class PasswordTokenGrantTypeProcessorTest extends OAuth2TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->userCredentialsChecker = $this->mock('Akamon\OAuth2\Server\Service\UserCredentialsChecker\UserCredentialsCheckerInterface');
        $this->tokenCreator = $this->mock('Akamon\OAuth2\Server\Service\TokenCreator\TokenCreatorInterface');
