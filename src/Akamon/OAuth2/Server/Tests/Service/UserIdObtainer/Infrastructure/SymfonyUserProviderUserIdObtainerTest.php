...
namespace Akamon\OAuth2\Server\Tests\Service\UserIdObtainer\Infrastructure;

use Akamon\OAuth2\Server\Service\UserIdObtainer\Infrastructure\SymfonyUserIdObtainer;
